...
2. New update: Now you can view dungeon map by clicking location icon on bigmap.(only in towns)
3. Character icon will show where you are now.
4. Hover on the location will display the map completion of each area total.
5. Modified very few files, almost compatible with any version.
6. No cheating content.
...
ver0.901
- New update: Now you can view dungeon map by clicking location icon on bigmap.(only in towns)
...
ver0.901
- 现在可以点击大地图上的地点图标，打开查看详细迷宫了。（目前只能在城镇里打开）
